...
def sift_match(img1, img2, ocr_reader, T=0.7, rate=0.5, color=(0, 255, 0)):
    ...
    if des1 is not None and des2 is not None:
        ...
        if count > rate * max(c1, c2) and count > 4:
            ...
            if img_name[-3:] == 'png' or img_name[-3:] == 'jpg':
                ...
                for i in range(0, n - 1):
                    ...
                    for j in range(i + 1, n):
                        ...
                        img3 = sift_match(img1, img2, ocr_reader, T=T, rate=rate, color=color)
                        if img3 is not None:
...
if __name__ == '__main__':
    ...
    res_path = f"/home/hdd1/data/wanfang/{year}/sift_v3_3/{batch}"
